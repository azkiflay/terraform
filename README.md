...
Surely, they would have known if they had access to the latest **terraform.state**. However, coordination problems arose because multiple and different **terraform.state** files exist on the local machines of the team members who made changes to the infrastructure. To solve this problem, the team can work using a centralized copy of **terraform.state**.
